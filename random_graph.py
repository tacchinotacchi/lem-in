...
for i in range(0, nodes):
    if i == endpoints[0]:
        print("##start")
        print("start", random.randint(0, 100000), random.randint(0, 100000))
    elif i == endpoints[1]:
        print("##end")
        print("end", random.randint(0, 100000), random.randint(0, 100000))
    else:
        print(i, random.randint(0, 100000), random.randint(0, 100000), sep=" ")
